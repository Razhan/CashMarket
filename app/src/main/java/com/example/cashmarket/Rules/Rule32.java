 ...
 */
public class Rule32 extends Rules{
    public Rule32(){
    ...
    private Boolean Addition0(ArrayList<String> nodes){
        if (nodes.size() >= 11){
            ...
            String temp7 = nodes.get(nodes.size() - 11);
            String[] array7 = temp7.split(",");
            if (!array7[1].equals("-1")) return false;
