...
public class StatisticsFileChooser extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentDir = new File(getApplicationInfo().dataDir,"shared_prefs");
        fill(currentDir);
    }
    ...
    private void fill(File f) {
        ...
        try{
            for(File ff: dirs)
            {
                  if (!ff.getName().contains("password")) {
        ...
        dir.addAll(fls);
        adapter = new FileArrayAdapter(StatisticsFileChooser.this,R.layout.activity_statistics_file_chooser,dir);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        intent.setClass(StatisticsFileChooser.this, Success.class);
        StatisticsFileChooser.this.startActivity(intent);
    }
            ...
            if (o != null) {
                ...
                remove.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        new AlertDialog.Builder(StatisticsFileChooser.this)
                                .setTitle("确认")
