...
public class Rule4 extends Rules{
    ...
    private Boolean Addition1(ArrayList<String> nodes){
        if (nodes.size() >= 12){
            ...
            if (nodes.size() > 12){
                String temp12 = nodes.get(nodes.size() - 13);
